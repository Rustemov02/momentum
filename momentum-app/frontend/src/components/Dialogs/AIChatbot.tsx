...
export const AIChatbot: React.FC<AIChatbotProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-24 lg:bottom-6 right-6 lg:right-24 w-[380px] max-w-[calc(100vw-3rem)] h-[500px] max-h-[calc(100vh-8rem)] z-40 animate-in slide-in-from-bottom-5 duration-300">
